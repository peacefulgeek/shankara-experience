        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/70 font-medium">
              ...
              <li><Link href="/mantras-and-sutras"><span className="hover:text-primary hover:drop-shadow-[0_0_8px_rgba(255,0,255,0.8)] cursor-pointer transition-all duration-300">Mantras & Sutras</span></Link></li>
            </ul>
          </div>
