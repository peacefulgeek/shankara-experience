  ...
  return (
    <div className="min-h-screen text-foreground font-sans selection:bg-accent selection:text-white overflow-x-hidden relative bg-[#fcfcfc]">
      ...
      <div className="relative h-[60vh] w-full overflow-hidden">
        ...
        />
        <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-[#fcfcfc] to-transparent z-20" />
      </div>

      <div className="container mx-auto px-4 relative z-30 -mt-20">
        <div className="max-w-4xl mx-auto bg-white rounded-t-3xl shadow-xl p-8 md:p-16 border-t border-gray-100">
          
          {/* Back Link */}
          <Link href="/wisdom">
            <a className="inline-flex items-center text-gray-400 hover:text-accent font-bold uppercase tracking-widest text-xs mb-8 transition-colors">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-display font-bold text-[#1a0b2e] mb-6 leading-tight">
              {article.title}
            </h1>
            <p className="text-xl md:text-2xl text-gray-500 font-light italic font-serif">
              {article.subtitle}
            </p>
            
            <div className="flex items-center justify-center gap-6 mt-8 text-xs font-bold uppercase tracking-widest text-gray-400">
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            {/* Main Content */}
            <article className="lg:w-3/4 prose prose-lg prose-purple max-w-none">
              {article.content}
            </article>
            ...
            <aside className="lg:w-1/4 space-y-8">
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 sticky top-32">
                <div className="w-20 h-20 rounded-full overflow-hidden mx-auto mb-4 border-2 border-white shadow-md">
                   <img src="/images/paul-wagner-avatar.jpg" alt={article.author} className="w-full h-full object-cover" />
                </div>
                <div className="text-center mb-4">
                  <h3 className="font-display font-bold text-[#1a0b2e]">Written by</h3>
                  <p className="text-accent font-bold uppercase text-xs tracking-widest">{article.author}</p>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <h4 className="font-bold text-xs uppercase tracking-widest text-gray-400 mb-3 text-center">Share this</h4>
                  <div className="flex justify-center gap-4">
                    <Button variant="ghost" size="icon" className="rounded-full hover:bg-purple-100 text-purple-900">
                      <Share2 size={16} />
                    </Button>
                  </div>
                </div>
      ...
      {/* Related / Next Read */}
      <section className="bg-gray-50 py-20 mt-12 border-t border-gray-200">
        <div className="container mx-auto px-4 text-center">
          <h3 className="font-display font-bold text-2xl text-[#1a0b2e] mb-8">Continue Reading</h3>
          <Link href="/wisdom">
             <Button variant="outline" className="rounded-full px-8 border-gray-300 text-gray-600 hover:border-accent hover:text-accent">
               View All Articles
             </Button>
          </Link>
        </div>
