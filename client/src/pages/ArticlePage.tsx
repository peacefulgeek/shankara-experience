            ...
            <div>
              ...
              <div className="flex gap-2">
                <Button 
                  variant="outline" 
                  size="icon" 
                  className="rounded-full text-gray-600 hover:bg-accent hover:text-white hover:border-accent transition-colors"
                  onClick={() => {
                ...
                <Button 
                  ...
                  className="rounded-full text-gray-600 hover:bg-accent hover:text-white hover:border-accent transition-colors"
                  onClick={() => {
                    const url = `https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(article.title + ' | The Shankara Experience')}`;
                    window.open(url, '_blank', 'width=600,height=400');
                  }}
                >
