...
const readers = [
  {
    ...
    bio: "Welcome! I am Paul Wagner, also known as Krishna Kalesh. I channeled and created The Shankara Oracle over ten years as my heart's offering to your awakening. Born from decades of mystical practice, psychic intuition, and profound love for the human spirit, this Oracle is a map to your soul's liberation. Every card is a living transmission encoded with insights from the sages, truths from ancient lineages, and the wild breath of the Divine. My readings will not coddle you. They will embrace you and walk you into the most empowered version of yourself.\n\nI created Shankara for seekers, visionaries, lovers, and those ready to shatter illusions and remember who they truly are. This divine tool will not worship your ego. It is raw, real, and radiant with fire and grace. It will challenge you, change you, adore you, and show you the mirrors you have been avoiding. If you crave clarity, truth, and connection to your deeper Self, you have found the sacred tool. My readings will give you confidence to finally heal and transform your life.",
  ...
  },
  {
    ...
    bio: "Ana Andrea Guidance is a warm, deeply intuitive spiritual guide who serves as both content director and business partner for Shankara. Her readings offer profound healing that reaches into the innermost chambers of her clients' hearts. Graced with exceptional intuition and genuine compassion, Ana distinguishes herself through the authentic personal connections she forges with each soul she guides. Her sessions become peaceful sanctuaries where individuals find themselves gently uplifted and realigned with their true paths. Ana's presence and practice illuminate the transformative power that flows through empathy and refined intuition.\n\nAna Andrea Guidance este un ghid spiritual cald și profund intuitiv, care servește atât ca director de conținut, cât și ca partener de afaceri pentru Shankara. Lecturile sale oferă o vindecare profundă care pătrunde în cele mai adânci camere ale inimilor clienților săi. Binecuvântată cu o intuiție excepțională și o compasiune autentică, Ana se distinge prin conexiunile personale autentice pe care le creează cu fiecare suflet pe care îl ghidează. Sesiunile sale devin sanctuare pașnice în care indivizii se simt ușor înălțați și realiniați cu adevăratele lor căi. Prezența și practica Anei luminează puterea transformatoare care curge prin empatie și intuiție rafinată.",
  ...
  },
  {
    ...
    website: "mailto:suzanneavision@gmail.com", 
    contactType: "email"
  },
  {
    name: "Paula Londoño",
  ...
  },
  {
    ...
    website: "mailto:jacksoncm.unk@gmail.com", 
    contactType: "email"
  }
];
